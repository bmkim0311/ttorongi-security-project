...
| ADMIN | 6000 / 6001 | Flask 백엔드 6000, 보안 구성에서의 관리자 접근 포트 6001 |
...
팀 프로젝트에서 웹 서버 및 서비스 연동, pfSense/Wazuh 구성, 문서화와 전체 연결 작업을 맡았으며 팀장으로 프로젝트를 진행했습니다. 단순히 취약점을 찾는 데서 끝내지 않고 **분석 → 보완 → 재검증** 과정이 이어지도록 전체 흐름을 구성했습니다.
